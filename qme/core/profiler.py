"""Performance profiling system for QME.
...
class PerformanceProfiler:
    """Comprehensive performance profiler for QME operations.
    ...
    def _get_memory_info(self) -> MemoryInfo:
        ...
        return MemoryInfo(ram_mb=ram_mb, gpu_mb=gpu_mb, ram_percent=ram_percent, gpu_percent=gpu_percent)
    ...
    def _calculate_memory_stats(self) -> dict[str, Any]:
        ...
        gpu_values = [snapshot[1].gpu_mb for snapshot in self._memory_snapshots if snapshot[1].gpu_mb is not None]
