...
for basic cases while preserving QME's advanced features.
"""
...
if TYPE_CHECKING:
    from qme.analysis.hessian import CalculatorProtocol
...
def can_use_ase(
    ...
    # but we don't use it here since QME doesn't leverage GPU parallelization
