...
class MLPCalculator(Calculator):
    ...
    def _mock_forces_calculation(self, geometry: Geometry) -> np.ndarray:
        ...
        for i in range(len(geometry.coords)):
            ...
            geom_plus = Geometry(geometry.atoms, coords_plus, charge=geometry.charge, mult=geometry.mult)
            ...
            geom_minus = Geometry(geometry.atoms, coords_minus, charge=geometry.charge, mult=geometry.mult)
