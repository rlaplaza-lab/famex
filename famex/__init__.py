...
def __getattr__(name: str) -> Any:
    ...
    _LAZY_IMPORTS = {
        ...
        "UMAPotential": (f"{__name__}.potentials.uma_potential", "UMAPotential"),
        "get_uma_calculator": (f"{__name__}.potentials", "get_uma_calculator"),
        "SO3LRPotential": (f"{__name__}.potentials.so3lr_potential", "SO3LRPotential"),
        "get_so3lr_calculator": (f"{__name__}.potentials", "get_so3lr_calculator"),
        "AIMNet2Potential": (f"{__name__}.potentials.aimnet2_potential", "AIMNet2Potential"),
        "get_aimnet2_calculator": (f"{__name__}.potentials", "get_aimnet2_calculator"),
        "MACEPotential": (f"{__name__}.potentials.mace_potential", "MACEPotential"),
        "get_mace_calculator": (f"{__name__}.potentials", "get_mace_calculator"),
        "PETPotential": (f"{__name__}.potentials.pet_potential", "PETPotential"),
