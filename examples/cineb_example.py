    ...
    try:
        ...
        for i, atoms in enumerate(result):
            try:
                ...
                print(f"   Image {i:2d}: Energy = {energy:8.4f} eV, Max Force = {max_force:.4f} eV/Å")
            except Exception:
        ...
        if energies and not all(np.isnan(energies)):
            ...
            if valid_energies:
                ...
                print(f"   This is likely the transition state!")
    ...
    try:
        ...
        if cineb_energies and not all(np.isnan(cineb_energies)):
            ...
            if valid_energies:
                ...
                print(f"   CI-NEB highest energy: Image {cineb_max_idx} ({cineb_max_energy:.4f} eV)")
