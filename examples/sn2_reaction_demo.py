...
def main():
    ...
    print(f"Reactants created: CH₃Cl + OH⁻ ({reactants.natoms} atoms, charge = {reactants.charge})")
    print(f"Products created: CH₃OH + Cl⁻ ({products.natoms} atoms, charge = {products.charge})")
    ...
    if c_cl_distances[-1] > c_cl_distances[0] + 0.5 and c_o_distances[0] > c_o_distances[-1] + 0.5:
        print("✓ Mechanism shows expected SN2 behavior: C-Cl bond breaks while C-O bond forms")
    else:
