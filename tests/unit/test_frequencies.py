...
class TestFrequencyBasics:
    ...
    def test_molecule_degrees_of_freedom(self, molecule_name, expected_dof):
    ...
    def test_hessian_and_modes(self, molecule_name):
...
class TestHessianCalculator:
    ...
    def test_hessian_dimensions(self, indices, expected_shape):
