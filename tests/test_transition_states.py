...
class TestTransitionStateOptimization:
    ...
    def test_sella_availability(self, qme_optimizer):
        ...
        assert "Sella" in qme_optimizer.AVAILABLE_OPTIMIZERS, \
    ...
    def test_h2_dissociation_ts(self, qme_optimizer):
        ...
        try:
            ...
            acceptable_errors = [
                ...
                "MGS failed",
                'inf', 'nan', 'singular', 'numerical', 'convergence',
    ...
    def test_ammonia_inversion_ts(self, qme_optimizer):
        ...
        try:
            ...
            error_msg = str(e).lower()
            numerical_errors = [
                'inf', 'nan', 'singular', 'convergence', 'matrix',
                'eigenvalue', 'hessian', 'numerical'
            ]
    ...
    def test_sn2_like_ts(self, qme_optimizer):
        ...
        try:
            ...
            error_msg = str(e).lower()
            expected_errors = [
                'inf', 'nan', 'singular', 'numerical', 'matrix',
                'convergence', 'eigenvalue', 'hessian'
            ]
    ...
    def test_proton_transfer_ts(self, qme_optimizer):
        ...
        try:
            ...
            error_msg = str(e).lower()
            expected_failures = [
                'inf', 'nan', 'singular', 'numerical', 
                'convergence', 'matrix', 'eigenvalue'
            ]
    ...
    def test_ts_optimization_parameters(self, qme_optimizer):
        ...
        for params in test_params:
            try:
                ...
                error_msg = str(e).lower()
                numerical_errors = [
                    'inf', 'nan', 'singular', 'convergence',
                    'numerical', 'matrix', 'eigenvalue'
                ]
                assert any(err in error_msg for err in numerical_errors)
    ...
    def test_ts_search_without_sella(self):
        ...
        if "Sella" in qme.AVAILABLE_OPTIMIZERS:
            qme.AVAILABLE_OPTIMIZERS = {k: v for k, v in original_optimizers.items() 
                                      if k != "Sella"}
