...
class TestGeometry:
    ...
    def test_coords3d_setter(self, water_molecule):
        ...
        new_coords = np.array([[1.0, 0.0, 0.0], [2.0, 0.0, 0.0], [1.5, 1.0, 0.0]])
...
H   -0.240000    0.930000    0.000000"""
    ...
    def test_invalid_dimensions(self):
        ...
        with pytest.raises(
            ValueError, match="Coordinates array must have 3\\*N elements"
        ):
        ...
        with pytest.raises(
            ValueError, match="Forces array must match coordinates dimensions"
        ):
            coords = np.array([0.0, 0.0, 0.0, 0.74, 0.0, 0.0])
